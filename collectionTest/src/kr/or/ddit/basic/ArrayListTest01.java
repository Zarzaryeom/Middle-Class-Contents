...
public class ArrayListTest01 {
	...
	public static void main(String[] args) {
		...
		//String[] strArr = (String[])list2.toArray(); // 실행하면 형변환 오류가 발생한다. 오류 메세지 :java.lang.ClassCastException
		...
		String[] strArr2 = list2.toArray(new String[0]); // 객체를 지정해 형변환한 모습, 이렇게하고 실행하면 오류가 발생하지 않는다.
